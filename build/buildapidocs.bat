...
rmdir /s /q %SRCDIR%\NodaTime.Testing\bin\Release
rmdir /s /q %SRCDIR%\NodaTime.Serialization.JsonNet\bin\Release
...
dotnet build --configuration Release ..\src\NodaTime
dotnet build --configuration Release ..\src\NodaTime.Serialization.JsonNet
dotnet build --configuration Release ..\src\NodaTime.Testing
