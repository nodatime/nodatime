...
%SRCDIR%\NodaTime.TzdbCompiler\bin\Release\NodaTime.TzdbCompiler.exe -o %SRCDIR%\NodaTime\TimeZones\Tzdb.nzd -s %DATADIR%\tzdb\%1 -w %DATADIR%\cldr -t %SRCDIR%\NodaTime.Test\TestData\tzdb-dump.txt
