...
{
    public class DocfxAnnotationGenerator
    {
        ...
        public static void GenerateDocfxAnnotations(string docfxRoot, string packagesDirectory, string sourceRoot, string[] versions)
        {
            // if (args.Length < 4)
            // {
            ...
            var instance = new DocfxAnnotationGenerator(versions, docfxRoot, packagesDirectory, sourceRoot);
        ...
        private DocfxAnnotationGenerator(IEnumerable<string> versions, string docfxRoot, string packagesDir, string srcRoot)
        {
