...
if [[ "$1" = "" ]]
then
  echo "Usage: update-1.3.sh tzdb-release-number"
  echo "e.g. update-1.3.sh 2013h"
  exit 1
fi
...
git clone https://github.com/nodatime/nodatime.git -b 1.3.x
mkdir old
mkdir output
...
echo "- Push commit to github: git push origin 1.3.x"
