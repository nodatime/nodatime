...
if [[ "$1" = "" ]]
then
  echo "Usage: update-2.1.sh tzdb-release-number"
  echo "e.g. update-2.1.sh 2013h"
  exit 1
fi
...
git clone https://github.com/nodatime/nodatime.git -b 2.1.x
mkdir old
mkdir output
...
echo "- Push commit to github: git push origin 2.1.x"
