...
Details are in the [week year page](weekyears.md).

ISO
===

First supported in v1.0.0  
API access: [`CalendarSystem.Iso`](../api/NodaTime.CalendarSystem.yml#NodaTime_CalendarSystem_Iso)
...
- [`CalendarSystem.Gregorian`](../api/NodaTime.CalendarSystem.yml#NodaTime_CalendarSystem_Gregorian)
...
First supported in v1.0.0  
API access: [`CalendarSystem.Julian`](../api/NodaTime.CalendarSystem.yml#NodaTime_CalendarSystem_Julian)
...
First supported in v1.0.0  
API access: [`CalendarSystem.Coptic`](../api/NodaTime.CalendarSystem.yml#NodaTime_CalendarSystem_Coptic)
...
- [`CalendarSystem.GetIslamicCalendar()`](../api/NodaTime.CalendarSystem.yml#NodaTime_CalendarSystem_GetIslamicCalendar_NodaTime_Calendars_IslamicLeapYearPattern_NodaTime_Calendars_IslamicEpoch_)
- [`CalendarSystem.IslamicBcl`](../api/NodaTime.CalendarSystem.yml#NodaTime_CalendarSystem_IslamicBcl)
...
- [`CalendarSystem.PersianSimple`](../api/NodaTime.CalendarSystem.yml#NodaTime_CalendarSystem_PersianSimple)
- [`CalendarSystem.PersianAstronomical`](../api/NodaTime.CalendarSystem.yml#NodaTime_CalendarSystem_PersianAstronomical)
- [`CalendarSystem.PersianArithmetic`](../api/NodaTime.CalendarSystem.yml#NodaTime_CalendarSystem_PersianArithmetic)
...
API access: [`CalendarSystem.UmAlQura`](../api/NodaTime.CalendarSystem.yml#NodaTime_CalendarSystem_UmAlQura)
...
- [`CalendarSystem.GetHebrewCalendar()`](../api/NodaTime.CalendarSystem.yml#NodaTime_CalendarSystem_GetHebrewCalendar_NodaTime_Calendars_HebrewMonthNumbering_)
- [`CalendarSystem.HebrewCivil`](../api/NodaTime.CalendarSystem.yml#NodaTime_CalendarSystem_HebrewCivil)
- [`CalendarSystem.HebrewScriptural`](../api/NodaTime.CalendarSystem.yml#NodaTime_CalendarSystem_HebrewScriptural)
