...
[building and testing](building.md) section in the developer guide).
...
`1.0.x`) and [build and run all the tests](building.md) as normal. The build
...
["Updating the time zone database"][../unstable/userguide/tzdb.md] section in the user guide.
