...
namespace NodaTime.Benchmarks
{
    internal class InstantBenchmarks
    {
        ...
        private static readonly IParsedPattern<Instant> GeneralParsedPattern =
            NodaFormatInfo.InvariantInfo.InstantPatternParser.ParsePattern("g", ParseStyles.None).GetResultOrThrow();
        private static readonly IParsedPattern<Instant> NumberParsedPattern =
            NodaFormatInfo.InvariantInfo.InstantPatternParser.ParsePattern("n", ParseStyles.None).GetResultOrThrow();

        [Benchmark]
        public void TryParseExact_Valid_General_WithNewCode()
        {
            Instant result;
            Instant.TryParseExact("2011-08-21T08:11:30Z", "g", InvariantFormatInfo, ParseStyles.None, out result);
        }
        ...
        {
            Instant result;
            Instant.TryParseExact("123456789", "n", InvariantFormatInfo, ParseStyles.None, out result);
        }
        ...
        {
            Instant result;
            Instant.TryParseExact("2011-13-21T08:11:30Z", "g", InvariantFormatInfo, ParseStyles.None, out result);
        }
        ...
        {
            Instant result;
            Instant.TryParseExact("12345xyz", "n", InvariantFormatInfo, ParseStyles.None, out result);
        }
