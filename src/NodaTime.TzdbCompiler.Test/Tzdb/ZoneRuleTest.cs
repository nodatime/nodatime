...
namespace NodaTime.TzdbCompiler.Test.Tzdb
{
    ...
    public class ZoneRuleTest
    {
        ...
        private static ZoneLine GetZone(string nameFormat, Offset standardOffset)
        {
            return new ZoneLine("Zone", standardOffset, "Rule", nameFormat, 2000, ZoneYearOffset.StartOfYear);
        }
    }
}
