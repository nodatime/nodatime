...
namespace NodaTime.CheckTimeZones
{
    internal class Options
    {
        ...
        [Option(null, "from", HelpText = "'From' year: the first year to show transitions from.", DefaultValue = -9998)]
        public int FromYear { get; set; }

        [Option(null, "to", HelpText = "'To' year: the last year to show transitions from", DefaultValue = 2049)]
        public int ToYear { get; set; }

        [Option(null, "includeFinal", HelpText = "Whether to always include the final zone interval", DefaultValue = true)]
