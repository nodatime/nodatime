...
namespace NodaTime.Text
{
    internal sealed class OffsetDateTimePatternParser : IPatternParser<OffsetDateTime>
    {
            ...
            new Dictionary<char, CharacterHandler<OffsetDateTime, OffsetDateTimeParseBucket>>
        {
            ...
            { 'r', DatePatternHelper.Create4Or5DigitYearHandler<OffsetDateTime, OffsetDateTimeParseBucket>(value => value.YearOfCentury, value => value.Year, (bucket, value) => bucket.Date.Year = value) },
