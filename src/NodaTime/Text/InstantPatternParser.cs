...
namespace NodaTime.Text
{
    ...
    internal sealed class InstantPatternParser : IPatternParser<Instant>
    {
        ...
        public PatternParseResult<Instant> ParsePattern(string pattern, Globalization.NodaFormatInfo formatInfo, ParseStyles parseStyles)
        {
            ...
            {
                case 'g':
                    return PatternParseResult<Instant>.ForValue(new GeneralParsedPattern(formatInfo, parseStyles));
                case 'n':
                    return PatternParseResult<Instant>.ForValue(new NumberParsedPattern(formatInfo, parseStyles, pattern, "N0"));
                case 'd':
                    return PatternParseResult<Instant>.ForValue(new NumberParsedPattern(formatInfo, parseStyles, pattern, "D"));
                default:
        ...
        private sealed class GeneralParsedPattern : AbstractParsedPattern<Instant>
        {
            ...
            internal GeneralParsedPattern(NodaFormatInfo formatInfo, ParseStyles parseStyles)
        ...
        private sealed class NumberParsedPattern : AbstractParsedPattern<Instant>
        {
            ...
            internal NumberParsedPattern(NodaFormatInfo formatInfo, ParseStyles parseStyles, string pattern, string systemFormatString)
                : base(formatInfo, parseStyles)
            {
