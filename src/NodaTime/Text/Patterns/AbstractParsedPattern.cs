...
namespace NodaTime.Text.Patterns
{
    ...
    internal abstract class AbstractParsedPattern<T> : IParsedPattern<T>
    {
        ...
        protected ParseStyles ParseStyles { get { return parseStyles; } }

        protected AbstractParsedPattern(NodaFormatInfo formatInfo, ParseStyles parseStyles)
        {
        ...
        /// <summary>
        /// Performs the first part of the parse, validating the value and trimming it, before
