...
namespace NodaTime.Periods
{
    ...
    public sealed class Hours : SingleFieldPeriodBase, IEquatable<Hours>, IComparable<Hours>
    {
        ...
        /// </para>
        /// </summary>        
        /// <returns>A period representing the number of whole weeks for this number of hours</returns>
        public Weeks ToStandardWeeks()
        {
            return Weeks.From(Value / NodaConstants.HoursPerWeek);
        }
        ...
        /// </para>
        /// </summary>        
        /// <returns>A period representing the number of whole days for this number of hours</returns>
        public Days ToStandardDays()
        {
            return Days.From(Value / NodaConstants.HoursPerDay);
        }
        ...
        {
            return Minutes.From(Value * NodaConstants.MinutesPerHour);
        }
        ...
        /// <para>
        /// This method allows you to convert between different types of period.
        /// However to achieve this it makes the assumption that 
        ...
        {
            return Seconds.From(Value * NodaConstants.SecondsPerHour);
        }
        ...
        /// <para>
        /// This method allows you to convert between different types of period.
        /// However to achieve this it makes the assumption that all hours are 60 minutes long and
        ...
        /// </para>
        /// </summary>        
        /// <returns>A duration equivalent to this number of hours</returns>
        public Duration ToStandardDuration()
        {
            return new Duration(Value * NodaConstants.MillisecondsPerHour);
        }
        #endregion
        ...
        /// <summary>
        /// Returns the same instance. Friendly alternative for <c>Hours.operator +(Hours)</c> operator.
        /// </summary>
        /// <param name="period">The operand.</param>
        /// <returns>The same <see cref="Hours"/> instance</returns>
        public static Hours Plus(Hours period)
        {
            return period;
        }
        ...
        /// <summary>
        /// Increments the given period by 1. Friendly alternative for <c>Hours.operator ++(Hours)</c> operator.
        /// </summary>
        /// <param name="period">The period to increment.</param>
        /// <returns>A new <see cref="Hours"/> instance with incremented value.</returns>
        public static Hours Increment(Hours period)
        {
            return ++period;
        }
        ...
        /// <summary>
        /// Decrements the given period by 1. Friendly alternative for <c>Hours.operator --(Hours)</c> operator.
        /// </summary>
        /// <param name="period">The period to decrement.</param>
        /// <returns>A new <see cref="Hours"/> instance with decremented value.</returns>
        public static Hours Decrement(Hours period)
        {
            return --period;
        }
        ...
        {
            return hours == 0 ? this : From(Value + hours);
        }
        ...
        /// This instance is immutable and unaffected by this method call.
        /// </remarks>
        public Hours Multiply(int scalar)
        {
        ...
        /// This instance is immutable and unaffected by this method call.
        /// </remarks>
        public Hours Divide(int divisor)
        {
        ...
        public static Hours operator /(Hours left, Hours right)
        {
            return ReferenceEquals(left, null) ? right : left.Divide(right);
        }
