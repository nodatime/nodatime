...
namespace NodaTime.Periods
{
    public sealed partial class Period : IPeriod, IEquatable<Period>
    {
        ...
        /// </para>
        /// </remarks>
        public static Period From(Duration duration, CalendarSystem calendar, PeriodType periodType)
        {
        ...
        {
            return From(LocalInstant.LocalUnixEpoch, LocalInstant.LocalUnixEpoch + duration, CalendarSystem.Iso, periodType);
        }
