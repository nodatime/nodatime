...
namespace NodaTime.Periods
{
    ...
    public sealed class Minutes : SingleFieldPeriodBase, IEquatable<Minutes>, IComparable<Minutes>
    {
        ...
        /// </para>
        /// </summary>        
        /// <returns>A period representing the number of whole weeks for this number of minutes</returns>
        public Weeks ToStandardWeeks()
        {
            return Weeks.From(Value / NodaConstants.MinutesPerWeek);
        }
        ...
        /// </para>
        /// </summary>        
        /// <returns>A period representing the number of whole days for this number of minutes</returns>
        public Days ToStandardDays()
        {
            return Days.From(Value / NodaConstants.MinutesPerDay);
        }
        ...
        /// </para>
        /// </summary>        
        /// <returns>A period representing the number of whole hours for this number of minutes</returns>
        public Hours ToStandardHours()
        {
            return Hours.From(Value / NodaConstants.MinutesPerHour);
        }
        ...
        /// </para>
        /// </summary>        
        /// <returns>A period representing the number of seconds for this number of minutes</returns>
        public Seconds ToStandardSeconds()
        {
            return Seconds.From(Value * NodaConstants.SecondsPerMinute);
        }
        ...
        /// </para>
        /// </summary>        
        /// <returns>A duration equivalent to this number of minutes</returns>
