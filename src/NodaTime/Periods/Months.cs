...
namespace NodaTime.Periods
{
    ...
    public sealed class Months : SingleFieldPeriodBase, IEquatable<Months>, IComparable<Months>
    {
        ...
        public static Months Plus(Months period)
        {
            return period;
        }
        ...
        /// <summary>
        /// Increments the given period by 1. Friendly alternative for <c>Months.operator ++(Months)</c> operator.
        /// </summary>
        /// <param name="period">The period to increment.</param>
        /// <returns>A new <see cref="Months"/> instance with incremented value.</returns>
        public static Months Increment(Months period)
        {
            return ++period;
        }
        ...
        /// <summary>
        /// Decrements the given period by 1. Friendly alternative for <c>Months.operator --(Months)</c> operator.
        /// </summary>
        /// <param name="period">The period to decrement.</param>
        /// <returns>A new <see cref="Months"/> instance with decremented value.</returns>
        public static Months Decrement(Months period)
        {
            return --period;
        }
