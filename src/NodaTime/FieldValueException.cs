...
namespace NodaTime
{
    ...
    public class FieldValueException : Exception
    {
        ...
        private static String CreateMessage(string fieldName, int value, long? lowerBound, long? upperBound, String explain)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("Value ").Append(value).Append(" for ").Append(fieldName).Append(' ');
            ...
            {
                sb.Append("must be in the range [").Append(lowerBound.Value).Append(',').Append(upperBound.Value).Append(']');
            }
            if (explain != null)
            {
