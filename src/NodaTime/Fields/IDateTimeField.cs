...
namespace NodaTime.Fields
{
    ...
    public interface IDateTimeField
    {
        ...
        /// </summary>
        DurationFieldBase DurationField { get; }

        /// <summary>
        /// Returns the range duration of this field. For example, if this field
        /// represents "hour of day", then the range duration is a day.
        /// </summary>
        DurationFieldBase RangeDurationField { get; }
        ...
        /// limit is reached by the add an exception is thrown. For example, in the ISO chronology:
        /// </para>
        /// <list type="bullet">
        ...
        /// </summary>
        DurationFieldBase LeapDurationField { get; }
        #endregion
