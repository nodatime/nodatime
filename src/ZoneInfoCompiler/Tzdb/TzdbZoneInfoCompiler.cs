...
namespace NodaTime.ZoneInfoCompiler.Tzdb
{
    ...
    internal class TzdbZoneInfoCompiler
    {
        ...
        {
            var builder = new DateTimeZoneBuilder(zoneList.Name);
        ...
        private static void ValidateArguments(DirectoryInfo source, IEnumerable<FileInfo> fileList)
        {
        ...
        private static void ValidateExistingDirectory(DirectoryInfo directory, string name)
        {
            if (directory == null)
            {
            ...
            if (!directory.Exists)
            {
                throw new ArgumentException(
                    @"The " + name + @" location does not exist or is not a directory: " + directory.FullName, name);
            }
        }
