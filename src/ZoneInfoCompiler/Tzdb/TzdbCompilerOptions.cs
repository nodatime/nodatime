...
{
    /// <summary>
    /// Defines the values that the type option can take.
    /// </summary>
    ...
    internal class TzdbCompilerOptions
    {
        ...
        public OutputType OutputType = OutputType.ResX;
        ...
        public string GetUsage()
        {
            ...
            help.AddPreOptionsLine(" ");
            help.AddPreOptionsLine("Usage: " + AssemblyInfo.Product + " -s source -o foo.resx");
            help.AddPreOptionsLine("       " + AssemblyInfo.Product + " -s source -o foo.resource --type Resource");
