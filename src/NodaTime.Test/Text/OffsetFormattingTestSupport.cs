...
namespace NodaTime.Test.Text
{
    ...
    public class OffsetFormattingTestSupport : FormattingTestSupport
    {
        ...
        internal static readonly OffsetData[] FormatData = {
            ...
            new OffsetData(5, 0, 0, 0) { C = Cultures.EnUs, S = "+05" },
            new OffsetData(5, 12, 0, 0) { C = Cultures.EnUs, S = "+05:12" },
            new OffsetData(5, 12, 34, 0) { C = Cultures.EnUs, S = "+05:12:34" },
            new OffsetData(5, 12, 34, 567) { C = Cultures.EnUs, S = "+05:12:34.567" },
        ...
        internal static readonly OffsetData[] CommonData = {
            ...
            new OffsetData(3, 0, 0, 0) { C = Cultures.EnUs, S = "+", P = "%+", PV = Offset.Zero  },
            new OffsetData(3, 0, 0, 0, true) { C = Cultures.EnUs, S = "-", P = "%+", PV = Offset.Zero  },
            new OffsetData(5, 0, 0, 0) { C = Cultures.EnUs, S = "+05", P = "g"  },
            new OffsetData(5, 12, 0, 0) { C = Cultures.EnUs, S = "+05:12", P = "g"  },
            new OffsetData(5, 12, 34, 0) { C = Cultures.EnUs, S = "+05:12:34", P = "g"  },
            new OffsetData(5, 12, 34, 567) { C = Cultures.EnUs, S = "+05", P = "s", PV = Offset.Create(5, 0, 0, 0)  },
            new OffsetData(5, 12, 34, 567) { C = Cultures.EnUs, S = "+05:12", P = "m", PV = Offset.Create(5, 12, 0, 0)  },
            new OffsetData(5, 12, 34, 567) { C = Cultures.EnUs, S = "+05:12:34", P = "l", PV = Offset.Create(5, 12, 34, 0)  },
            new OffsetData(5, 12, 34, 567) { C = Cultures.EnUs, S = "+05:12:34.567", P = "f"  },
            new OffsetData(5, 12, 34, 567) { C = Cultures.EnUs, S = "+05:12:34.567", P = "g"  },
            ...
            new OffsetData(Offset.Zero) { C = Cultures.EnUs, S = "+00", P = "s"  },
            new OffsetData(Offset.Zero) { C = Cultures.EnUs, S = "+00:00", P = "m"  },
            new OffsetData(Offset.Zero) { C = Cultures.EnUs, S = "+00:00:00", P = "l"  },
            new OffsetData(Offset.Zero) { C = Cultures.EnUs, S = "+00:00:00.000", P = "f"  },
            ...
            new OffsetData(5, 0, 0, 0) { C = Cultures.FrFr, S = "+05", P = "g" },
            new OffsetData(5, 12, 0, 0) { C = Cultures.FrFr, S = "+05:12", P = "g" },
            new OffsetData(5, 12, 34, 0) { C = Cultures.FrFr, S = "+05:12:34", P = "g" },
            new OffsetData(5, 12, 34, 567) { C = Cultures.FrFr, S = "+05:12:34.567", P = "g" }, // Note still a period, not a comma
            ...
            new OffsetData(5, 0, 0, 0) { C = Cultures.ItIt, S = "+05", P = "g" },
            new OffsetData(5, 12, 0, 0) { C = Cultures.ItIt, S = "+05.12", P = "g" },
            new OffsetData(5, 12, 34, 0) { C = Cultures.ItIt, S = "+05.12.34", P = "g" },
            new OffsetData(5, 12, 34, 567) { C = Cultures.ItIt, S = "+05.12.34.567", P = "g" },
