...
namespace NodaTime.Test.Text
{
    public class OffsetDateTimePatternTest : PatternTestBase<OffsetDateTime>
    {
        ...
        internal static Data[] ParseFailureData = {
            ...
            new Data { Pattern = "uuuu-MM-dd HH:mm", Text = "2011-10-19 24:00", Template = new LocalDateTime(1970, 1, 1, 0, 0, 5).WithOffset(Offset.Zero), Message = TextErrorMessages.InvalidHour24},
            new Data { Pattern = "uuuu-MM-dd HH", Text = "2011-10-19 24", Template = new LocalDateTime(1970, 1, 1, 0, 5, 0).WithOffset(Offset.Zero), Message = TextErrorMessages.InvalidHour24},

            new Data { Pattern = "uuuu-MM-dd HH:mm:ss o<+HH>", Text = "2011-10-19 16:02 +15:00", Message = TextErrorMessages.TimeSeparatorMismatch},
        };

        internal static Data[] ParseOnlyData = {
            // Parse-only tests from LocalDateTimeTest.
            new Data(2011, 10, 19, 16, 05, 20) { Pattern = "dd MM uuuu", Text = "19 10 2011", Template = new LocalDateTime(2000, 1, 1, 16, 05, 20).WithOffset(Offset.Zero) },
        ...
        internal static Data[] FormatAndParseData = {
            ...
            new Data(2015, 10, 24, 11, 55, 30, AthensOffset) { Pattern = "ld<uuuu*MM*dd>'X'lt<HH_mm_ss> o<g>", Text = "2015*10*24X11_55_30 +03" },
            new Data(2015, 10, 24, 11, 55, 30, AthensOffset) { Pattern = "lt<HH_mm_ss>'Y'ld<uuuu*MM*dd> o<g>", Text = "11_55_30Y2015*10*24 +03" },
            new Data(2015, 10, 24, 11, 55, 30, AthensOffset) { Pattern = "l<HH_mm_ss'Y'uuuu*MM*dd> o<g>", Text = "11_55_30Y2015*10*24 +03" },
            new Data(2015, 10, 24, 11, 55, 30, AthensOffset) { Pattern = "ld<d>'X'lt<HH_mm_ss> o<g>", Text = "10/24/2015X11_55_30 +03" },
            new Data(2015, 10, 24, 11, 55, 30, AthensOffset) { Pattern = "ld<uuuu*MM*dd>'X'lt<T> o<g>", Text = "2015*10*24X11:55:30 +03" },
            ...
            new Data(2015, 10, 24, 11, 55, 30, AthensOffset) { Pattern = "l<'X'lt<HH_mm_ss>'Y'ld<uuuu*MM*dd>'X'> o<g>", Text = "X11_55_30Y2015*10*24X +03" },
            ...
            new Data(2012, 1, 31, 17, 36, 45, 123) { Text = "2012-01-31T17:36:45x123", Pattern = "uuuu-MM-ddTHH:mm:ss'x'FFF" },
        ...
        {
            var pattern = OffsetDateTimePattern.CreateWithInvariantCulture("uuuu-MM-dd'T'HH:mm:sso<g>");
        ...
        {
            var pattern = OffsetDateTimePattern.CreateWithInvariantCulture("uuuu-MM-dd").WithPatternText("HH:mm");
        ...
        {
            var pattern = OffsetDateTimePattern.CreateWithInvariantCulture("uuuu-MM-dd")
