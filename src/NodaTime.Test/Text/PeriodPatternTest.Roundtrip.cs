    ...
    public partial class PeriodPatternTest
    {
        ...
        public class PeriodPatternRoundtripTest : PeriodPatternTest
        {
            internal static Data[] ParseFailureData = {
                ...
                new Data
                { Text = "P-10000000000000000000H", Message = Messages.Parse_ValueOutOfRange, Parameters = { "-10000000000000000000", typeof(Period) } },
            };
            ...
            internal static readonly Data[] FormatAndParseData = {
                // All single values                                                                
                new Data(new PeriodBuilder { Years = 5 }) { Text = "P5Y" }, new Data(new PeriodBuilder { Months = 5 }) { Text = "P5M" },
                new Data(new PeriodBuilder { Weeks = 5 }) { Text = "P5W" }, new Data(new PeriodBuilder { Days = 5 }) { Text = "P5D" },
                new Data(new PeriodBuilder { Hours = 5 }) { Text = "PT5H" }, new Data(new PeriodBuilder { Minutes = 5 }) { Text = "PT5M" },
                new Data(new PeriodBuilder { Seconds = 5 }) { Text = "PT5S" }, new Data(new PeriodBuilder { Milliseconds = 5 }) { Text = "PT5s" },
                new Data(new PeriodBuilder { Ticks = 5 }) { Text = "PT5t" }, // Compound, negative and zero tests
                new Data(new PeriodBuilder { Years = 5, Months = 2 }) { Text = "P5Y2M" },
                new Data(new PeriodBuilder { Months = 1, Hours = 0 }) { Text = "P1MT0H" },
                new Data(new PeriodBuilder { Months = 1, Minutes = -1 }) { Text = "P1MT-1M" }, // Max/min
