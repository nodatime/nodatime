...
namespace NodaTime.Test.TimeZones
{
    ...
    public class ZoneIntervalPairTest
    {
        ...
        {
            ZoneIntervalPair pair = new ZoneIntervalPair(new ZoneInterval("Foo", new Instant(0), new Instant(10), Offset.Zero, Offset.Zero), null);
        ...
        {
            ZoneIntervalPair pair = new ZoneIntervalPair(null, null);
        ...
        {
            ZoneIntervalPair pair = new ZoneIntervalPair(
