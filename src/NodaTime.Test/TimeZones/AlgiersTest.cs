...
namespace NodaTime.Test.TimeZones
{
    ...
    public class AlgiersTest
    {
        ...
        public void GetPeriod_AfterLastTransition()
        {
            ...
            var expected = new ZoneInterval("CET", Instant.FromTicksSinceUnixEpoch(3575232000000000L), Instant.MaxValue, Offset.FromMilliseconds(NodaConstants.MillisecondsPerHour), Offset.Zero);
            Assert.AreEqual(expected, actual);
        }
    }
}