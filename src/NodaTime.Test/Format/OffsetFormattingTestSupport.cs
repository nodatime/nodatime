...
namespace NodaTime.Test.Format
{
    ...
    public class OffsetFormattingTestSupport : FormattingTestSupport
    {
        ...
        internal static OffsetData[] OffsetParseData = {
            ...
            new OffsetData(12, 34, 0, 0) { C = EnUs, S = "12:34", F = "HH:mm", Styles = SurroundingSpace },
            new OffsetData(12, 34, 0, 0) { C = EnUs, S = "12:34", F = "HH:mm", Styles = TrailingSpace },
            new OffsetData(Offset.Zero) { C = EnUs, S = "", F = "g", Kind = ParseFailureKind.ValueStringEmpty },
            new OffsetData(Offset.Zero) { C = EnUs, S = "1", F = "HH", Kind = ParseFailureKind.MismatchedNumber, Parameters = {"HH"} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "1", F = "mm", Kind = ParseFailureKind.MismatchedNumber, Parameters = {"mm"} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "1", F = "ss", Kind = ParseFailureKind.MismatchedNumber, Parameters = {"ss"} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "12", F = "%f", Kind = ParseFailureKind.ExtraValueCharacters, Parameters = {"2"} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "12", F = "%F", Kind = ParseFailureKind.ExtraValueCharacters, Parameters = {"2"} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "12:34 ", F = "HH:mm", Kind = ParseFailureKind.ExtraValueCharacters, Parameters = {" "} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "", Kind = ParseFailureKind.FormatStringEmpty},
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "%%H", Kind = ParseFailureKind.PercentDoubled},
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "ff", Kind = ParseFailureKind.ExtraValueCharacters, Parameters = {"3"} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "FF", Kind = ParseFailureKind.ExtraValueCharacters, Parameters = {"3"} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = null, Kind = ParseFailureKind.ArgumentNull, ArgumentName = "format" },
            new OffsetData(Offset.Zero) { C = EnUs, S = "1234", F = "fff", Kind = ParseFailureKind.ExtraValueCharacters, Parameters = {"4"} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "1234", F = "FFF", Kind = ParseFailureKind.ExtraValueCharacters, Parameters = {"4"} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "1a", F = "H ", Kind = ParseFailureKind.MismatchedSpace},
            new OffsetData(Offset.Zero) { C = EnUs, S = "2:", F = "%H", Kind = ParseFailureKind.ExtraValueCharacters, Parameters = {":"}},
            new OffsetData(Offset.Zero) { C = EnUs, S = "a", F = "%.", Kind = ParseFailureKind.MissingDecimalSeparator},
            new OffsetData(Offset.Zero) { C = EnUs, S = "a", F = "%:", Kind = ParseFailureKind.TimeSeparatorMismatch},
            new OffsetData(Offset.Zero) { C = EnUs, S = "a", F = "%H", Kind = ParseFailureKind.MismatchedNumber, Parameters = {"H"} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "a", F = "%m", Kind = ParseFailureKind.MismatchedNumber, Parameters = {"m"} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "a", F = "%s", Kind = ParseFailureKind.MismatchedNumber, Parameters = {"s"} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "a", F = ".H", Kind = ParseFailureKind.MissingDecimalSeparator},
            new OffsetData(Offset.Zero) { C = EnUs, S = "a", F = "\\'", Kind = ParseFailureKind.EscapedCharacterMismatch, Parameters = {'\''} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "axc", F = "'abc'", Kind = ParseFailureKind.QuotedStringMismatch},
            new OffsetData(Offset.Zero) { C = EnUs, S = "z", F = "%y", Kind = ParseFailureKind.MismatchedCharacter, Parameters = {'y'} },
        ...
        internal static OffsetData[] OffsetFormattingCommonData = {
            ...
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "!", Kind = ParseFailureKind.UnknownStandardFormat, Parameters = {'!', typeof(Offset).FullName}},
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "%", Kind = ParseFailureKind.UnknownStandardFormat, Parameters = { '%', typeof(Offset).FullName } },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "%%", Kind = ParseFailureKind.PercentDoubled },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "%\\", Kind = ParseFailureKind.EscapeAtEndOfString },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "\\", Kind = ParseFailureKind.UnknownStandardFormat, Parameters = { '\\', typeof(Offset).FullName } },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "ffff", Kind = ParseFailureKind.RepeatCountExceeded, Parameters = { 'f', 3 } },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "H%", Kind = ParseFailureKind.PercentAtEndOfString },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "hh", Kind = ParseFailureKind.Hour12PatternNotSupported },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "HHH", Kind = ParseFailureKind.RepeatCountExceeded, Parameters = { 'f', 3 } },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "mmm", Kind = ParseFailureKind.RepeatCountExceeded, Parameters = { 'f', 3 } },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "mmmmmmmmmmmmmmmmmmm", Kind = ParseFailureKind.RepeatCountExceeded, Parameters = { 'f', 3 } },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "'qwe", Kind = ParseFailureKind.MissingEndQuote, Parameters = { '\'' } },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "'qwe\\", Kind = ParseFailureKind.EscapeAtEndOfString },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "'qwe\\'", Kind = ParseFailureKind.MissingEndQuote, Parameters = { '\'' } },
            new OffsetData(Offset.Zero) { C = EnUs, S = "123", F = "sss", Kind = ParseFailureKind.RepeatCountExceeded, Parameters = { 'f', 3 } },
