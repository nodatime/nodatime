...
//TODO: Bug? (results are interchanged)
        ...
        object[] ParseTestData =
        {
            new TestCaseData( Build(b=>b.AppendYearOfEra(0,4)),
                                "2008", new ZonedDateTime(2008,1,1,0,0,0,Chronology.IsoUtc))
                                .SetName("YearOfEra"),

            new TestCaseData( Build(b=>b.AppendYearOfCentury(0,4)),
                                "8", new ZonedDateTime(1908,1,1,0,0,0,Chronology.IsoUtc))
                                .SetName("YearOfCentury"),
            ...
            new TestCaseData( Build(b=>b.AppendMonthOfYear(0)),
                                "5", new ZonedDateTime(1970,5,1,0,0,0,Chronology.IsoUtc))
                                .SetName("MonthOfYear"),

            new TestCaseData( Build(b=>b.AppendWeekOfWeekYear(0)),
                                "2", new ZonedDateTime(1970,1,5,0,0,0,Chronology.IsoUtc))
                                .SetName("WeekOfWeekYear"),

            new TestCaseData( Build(b=>b.AppendDayOfYear(0)),
                                "32", new ZonedDateTime(1970,2,1,0,0,0,Chronology.IsoUtc))
                                .SetName("DayOfYear"),

            new TestCaseData( Build(b=>b.AppendDayOfMonth(0)),
                                "28", new ZonedDateTime(1970,1,28,0,0,0,Chronology.IsoUtc))
                                .SetName("DayOfMonth"),

            new TestCaseData( Build(b=>b.AppendDayOfWeek(0)),
                                "5", new ZonedDateTime(1970,1,2,0,0,0,Chronology.IsoUtc))
                                .SetName("DayOfWeek"),

            new TestCaseData( Build(b=>b.AppendHourOfDay(0)),
                                "19", new ZonedDateTime(1970,1,1,19,0,0,Chronology.IsoUtc))
                                .SetName("HourOfDay"),

            new TestCaseData( Build(b=>b.AppendClockHourOfDay(0)),
                                "10", new ZonedDateTime(1970,1,1,10,0,0,Chronology.IsoUtc))
                                .SetName("ClockHourOfDay"),

            new TestCaseData( Build(b=>b.AppendHourOfHalfDay(0)),
                                "6", new ZonedDateTime(1970,1,1,6,0,0,Chronology.IsoUtc))
                                .SetName("HourOfHalfDay"),

            new TestCaseData( Build(b=>b.AppendClockHourOfHalfDay(0)),
                                "5", new ZonedDateTime(1970,1,1,5,0,0,Chronology.IsoUtc))
                                .SetName("ClockHourOfHalfDay"),

            new TestCaseData( Build(b=>b.AppendMinuteOfDay(0)),
                                "620", new ZonedDateTime(1970,1,1,10,20,0,Chronology.IsoUtc))
                                .SetName("MinuteOfDay"),

            new TestCaseData( Build(b=>b.AppendMinuteOfHour(0)),
                                "30", new ZonedDateTime(1970,1,1,0,30,0,Chronology.IsoUtc))
                                .SetName("MinuteOfHour"),

            new TestCaseData( Build(b=>b.AppendSecondOfDay(0)),
                                "37230", new ZonedDateTime(1970,1,1,10,20,30,Chronology.IsoUtc))
                                .SetName("SecondOfDay"),

            new TestCaseData( Build(b=>b.AppendSecondOfMinute(0)),
                                "30", new ZonedDateTime(1970,1,1,0,0,30,Chronology.IsoUtc))
                                .SetName("SecondOfMinute"),

            new TestCaseData( Build(b=>b.AppendMillisecondsOfDay(0)),
                                "900", new ZonedDateTime(1970,1,1,0,0,0,900,Chronology.IsoUtc))
                                .SetName("MillisecondsOfDay"),

            new TestCaseData( Build(b=>b.AppendMillisecondsOfSecond(0)),
                                "50", new ZonedDateTime(1970,1,1,0,0,0,50,Chronology.IsoUtc))
                                .SetName("MillisecondsOfSecond"),
