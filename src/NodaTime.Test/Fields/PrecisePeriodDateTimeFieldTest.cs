...
{
    [TestFixture]
    public class PrecisePeriodDateTimeFieldTest
    {
        [Test]
        public void Constructor_GivenNullPeriodField_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(() => new StubPrecisePeriodDateTimeField(null));
        }
        ...
        public void Constructor_GivenZeroTicksPeriodField_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => new StubPrecisePeriodDateTimeField(badField));
        }

        [Test]
        public void Constructor_GivenImprecisePeriodField_ThrowsArgumentException()
        {
        ...
        {
            DateTimeField field = new StubPrecisePeriodDateTimeField();
        ...
        private class StubPrecisePeriodDateTimeField : PrecisePeriodDateTimeField
        {
            internal StubPrecisePeriodDateTimeField(PeriodField unit) : base(DateTimeFieldType.SecondOfMinute, unit)
            {
            }

            internal StubPrecisePeriodDateTimeField() : base(DateTimeFieldType.SecondOfMinute, new MockCountingPeriodField(PeriodFieldType.Seconds))
            {
            }
