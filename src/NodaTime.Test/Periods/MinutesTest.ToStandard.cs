...
namespace NodaTime.Test.Periods
{
    public partial class MinutesTest
    {
        ...
        {
            var sut = Minutes.From(2 * 7 * 24 * 60);
        ...
        {
            var sut = Minutes.From(2);
            var expected = Seconds.From(2 * 60);
        ...
        {
            var sut = Minutes.From(2);
            var expected = new Duration(2 * NodaConstants.MillisecondsPerMinute);
