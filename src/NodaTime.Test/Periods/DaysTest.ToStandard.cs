...
namespace NodaTime.Test.Periods
{
    public partial class DaysTest
    {
        ...
        {
            var sut = Days.From(2);
            var expected = Minutes.From(2 * 24 * 60);
        ...
        {
            var sut = Days.From(2);
            var expected = Seconds.From(2 * 24 * 60 * 60);
        ...
        {
            var sut = Days.From(2);
            var expected = new Duration(2 * NodaConstants.MillisecondsPerDay);
