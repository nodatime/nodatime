...
namespace NodaTime.Test
{
    partial class OffsetTest
    {
        ...
        public void OperatorPlus_Zero_IsNeutralElement()
        {
            ...
            Assert.AreEqual(Offset.Create(3, 0, 0, 0), ThreeHours + Offset.Zero, "1 + 0");
            Assert.AreEqual(Offset.Create(3, 0, 0, 0), Offset.Zero + ThreeHours, "0 + 1");
        }

        [Test]
        public void OperatorPlus_NonZero()
        {
            Assert.AreEqual(Offset.Create(6, 0, 0, 0), ThreeHours + ThreeHours, "3,000,000 + 1");
            Assert.AreEqual(Offset.Zero, ThreeHours + NegativeThreeHours, "1 + (-1)");
            Assert.AreEqual(Offset.Create(9, 0, 0, 0, true), NegativeTwelveHours + ThreeHours, "-TwelveHours + threeHours");
        }
        ...
        public void MethodAdd_Zero_IsNeutralElement()
        {
            ...
            Assert.AreEqual(Offset.Create(3, 0, 0, 0), Offset.Add(ThreeHours, Offset.Zero), "1 + 0");
            Assert.AreEqual(Offset.Create(3, 0, 0, 0), Offset.Add(Offset.Zero, ThreeHours), "0 + 1");
        }

        [Test]
        public void MethodAdd_NonZero()
        {
            Assert.AreEqual(Offset.Create(6, 0, 0, 0), Offset.Add(ThreeHours, ThreeHours), "3,000,000 + 1");
            Assert.AreEqual(Offset.Zero, Offset.Add(ThreeHours, NegativeThreeHours), "1 + (-1)");
            Assert.AreEqual(Offset.Create(9, 0, 0, 0, true), Offset.Add(NegativeTwelveHours, ThreeHours), "-TwelveHours + threeHours");
        }
        ...
        public void MethodPlus_Zero_IsNeutralElement()
        {
            ...
            Assert.AreEqual(Offset.Create(3, 0, 0, 0), ThreeHours.Plus(Offset.Zero), "1 + 0");
            Assert.AreEqual(Offset.Create(3, 0, 0, 0), Offset.Zero.Plus(ThreeHours), "0 + 1");
        }

        [Test]
        public void MethodPlus_NonZero()
        {
            Assert.AreEqual(Offset.Create(6, 0, 0, 0), ThreeHours.Plus(ThreeHours), "3,000,000 + 1");
            Assert.AreEqual(Offset.Zero, ThreeHours.Plus(NegativeThreeHours), "1 + (-1)");
            Assert.AreEqual(Offset.Create(9, 0, 0, 0, true), NegativeTwelveHours.Plus(ThreeHours), "-TwelveHours + threeHours");
        }
        #endregion
        ...
        public void OperatorMinus_Zero_IsNeutralElement()
        {
            ...
            Assert.AreEqual(Offset.Create(3, 0, 0, 0), ThreeHours - Offset.Zero, "1 - 0");
            Assert.AreEqual(Offset.Create(3, 0, 0, 0, true), Offset.Zero - ThreeHours, "0 - 1");
        }
        ...
        public void OperatorMinus_NonZero()
        {
            ...
            Assert.AreEqual(Offset.Create(6, 0, 0, 0), ThreeHours - NegativeThreeHours, "1 - (-1)");
            Assert.AreEqual(Offset.Create(15, 0, 0, 0, true), NegativeTwelveHours - ThreeHours, "-TwelveHours - threeHours");
        }
        ...
        public void Subtract_Zero_IsNeutralElement()
        {
            ...
            Assert.AreEqual(Offset.Create(3, 0, 0, 0), Offset.Subtract(ThreeHours, Offset.Zero), "1 - 0");
            Assert.AreEqual(Offset.Create(3, 0, 0, 0, true), Offset.Subtract(Offset.Zero, ThreeHours), "0 - 1");
        }
        ...
        public void Subtract_NonZero()
        {
            ...
            Assert.AreEqual(Offset.Create(6, 0, 0, 0), Offset.Subtract(ThreeHours, NegativeThreeHours), "1 - (-1)");
            Assert.AreEqual(Offset.Create(15, 0, 0, 0, true), Offset.Subtract(NegativeTwelveHours, ThreeHours), "-TwelveHours - threeHours");
        }
        ...
        public void Minus_Zero_IsNeutralElement()
        {
            ...
            Assert.AreEqual(Offset.Create(3, 0, 0, 0), ThreeHours.Minus(Offset.Zero), "1 - 0");
            Assert.AreEqual(Offset.Create(3, 0, 0, 0, true), Offset.Zero.Minus(ThreeHours), "0 - 1");
        }
        ...
        public void Minus_NonZero()
        {
            ...
            Assert.AreEqual(Offset.Create(6, 0, 0, 0), ThreeHours.Minus(NegativeThreeHours), "1 - (-1)");
            Assert.AreEqual(Offset.Create(15, 0, 0, 0, true), NegativeTwelveHours.Minus(ThreeHours), "-TwelveHours - threeHours");
        }
        #endregion
    }
}