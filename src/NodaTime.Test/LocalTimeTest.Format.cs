...
namespace NodaTime.Test
{
	public partial class LocalTimeTest
	{
        ...
        [Test, Category("Formatting"), Category("Format")]
        [TestCaseSource(typeof(LocalTimePatternTestSupport), "AllFormatData")]
        public void TestToString_Format(LocalTimePatternTestSupport.LocalTimeData data)
        {
            if (data.C != null)
            {
        ...
        [Test, Category("Formatting"), Category("Format")]
        [TestCaseSource(typeof(LocalTimePatternTestSupport), "AllFormatData")]
        public void TestToString_FormatCulture(LocalTimePatternTestSupport.LocalTimeData data)
        {
        ...
        [Test, Category("Formatting"), Category("Format")]
        [TestCaseSource(typeof(LocalTimePatternTestSupport), "FormatWithoutFormat")]
        public void TestToString_NoArg(LocalTimePatternTestSupport.LocalTimeData data)
        {
            if (data.C != null)
            {
                data.ThreadCulture = data.C;
